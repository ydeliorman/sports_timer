...
class NumberPickerFormatter {
  ...
  static int extractNumberPickerTime(String numberPickerType,  Map<String, String> _timerData) {
  ...
  static int formatTimeForSavedData(String numberPickerType,  TimerDetailModel _timerData) {
    int workDurationDecimalPart;

    ///if the number is 0 18 -> workDurationInDecimal will be 0.18
    var workDurationInDecimal = numberPickerType == "work" ? double.parse(_timerData.workDuration) : double.parse(_timerData.restDuration);
    int workDurationIntPart = workDurationInDecimal.toInt();
